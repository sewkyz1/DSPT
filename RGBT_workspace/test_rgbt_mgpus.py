...
if __name__ == '__main__':
    ...
    parser.add_argument('--script_name', type=str, default='sutrack', help='Name of tracking method(ostrack, prompt, ftuning).')
    ...
    parser.add_argument('--yaml_name', type=str, default='sutrack_b224', help='Name of tracking method.') 
    ...
    if dataset_name == 'GTOT':
        ...
        seq_home = '/data/disk1/keyuze/data/RGBT234'
        seq_list = [f for f in os.listdir(seq_home) if isdir(join(seq_home,f))]
        seq_list.sort()
    elif dataset_name == 'LasHeR':
        seq_home = '/media/kemove/Extreme Pro/tracking_datasets/RGBT/LasHeR0327/TestingSet/testingset'
        seq_list = [f for f in os.listdir(seq_home) if isdir(join(seq_home,f))]
        seq_list.sort()

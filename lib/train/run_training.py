...
def main():
    ...
    parser.add_argument('--script', type=str, default="sutrack", help='Name of the train script.')
    parser.add_argument('--config', type=str, default="sutrack_b224", help="Name of the config file.")

...
def run(settings):
    ...
    path_checkpoint = "weights/SUTRACK_ep0180.pth.tar"
    # path_checkpoint = "/data/disk1/keyuze/SUTRACK/SUTrack-main/checkpoints/train/sutrack/sutrack_b224_00001_60000_NOSAWM/SUTRACK_ep0060.pth.tar"
    # path_checkpoint = "/data/disk1/keyuze/SUTRACK/SUTrack-main/checkpoints/train/sutrack/rgbd/sutrack_b224_00001_60000_NOSAWM/SUTRACK_ep0060.pth.tar"
    # path_checkpoint = "/data/disk1/keyuze/SUTRACK/SUTrack-main/checkpoints/train/sutrack/rgbe/sutrack_b224_00001_60000_NOSAWM/SUTRACK_ep0040.pth.tar"
    # try:
    miss, unexpect = net.load_state_dict(torch.load(path_checkpoint, map_location='cpu')['net'], strict=False)
    print('Load pretrained model from: ' + path_checkpoint)
